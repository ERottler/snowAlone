...
rain=rep(c(rep(0,99),500),ceiling(length(datevec)/10))
...
temp=round(rep(c(seq(-10,3,length.out=50),seq(3,-10,length.out=50)),ceiling(length(datevec)/100)),digits=1) # in °C
